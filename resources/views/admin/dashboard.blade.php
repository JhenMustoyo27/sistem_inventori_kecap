...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <section class="bg-white p-6 rounded-xl shadow-md">
            ...
            <p class="text-gray-700">Selamat datang di Dashboard Admin Sistem Inventori Kecap Riboet Purwokerto. Di sini Anda dapat memantau ringkasan stok.</p>
            <p class="text-gray-700 mt-2">Gunakan menu di samping untuk mengakses fitur-fitur seperti Stok Masuk, Kelola Stok, Stok Keluar dan Laporan.</p>
        </section>
@endsection

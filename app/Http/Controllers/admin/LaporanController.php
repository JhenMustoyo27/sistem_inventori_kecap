...
{
    /**
     * Menampilkan laporan akhir stok.
     *
    ...
    public function index(Request $request)
    {
        ...
        $kecapMasukData = $query->orderBy('kode_kecap')->get();
        ...
        foreach ($kecapMasukData as $kecap) {
            ...
            $totalHargaJual = StokKeluar::where('kecap_masuk_id', $kecap->id)
            ...
            $laporan[] = [
                ...
                'tanggal_keluar_terakhir' => $tanggalKeluarTerakhir,
                'harga_jual' => $kecap->harga_jual,
                'total_harga_jual_dari_keluar' => $totalHargaJual,
            ];
        }
        ...
        return view('admin.laporan.index', compact('laporanPaginated'));
    }

    /**
     * Mengunduh laporan akhir stok dalam format PDF.
     *
     * @param  \Illuminate\Http\Request  $request
    ...
    public function downloadPdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.laporan.pdf_report', compact('laporan'));
        return $pdf->download('laporan_stok_akhir_' . date('Ymd_His') . '.pdf');
    }

    /**
     * Menampilkan laporan stok expired dan yang akan expired.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\View\View
     */
    public function expired(Request $request)
    {
        ...
        return view('admin.laporan.expired_report', compact('laporanExpiredPaginated'));
    }

    /**
     * Mengunduh laporan stok expired dan yang akan expired dalam format PDF.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\Response
     */
    public function downloadExpiredPdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.laporan.pdf_expired_report', compact('laporanExpired'));
